...
class Graph(object):
    ...
    def Floyd_Warshall(self,state,goals):
        dist = {}
    ...
    def minDistance(self, dist, sptSet):
            ...
            for v in self.V:
                #print('min = ', min)
                #print('v = ', v)
                #print('cur dist = ', dist[v])                
                #print('sptSet =', sptSet[v])
...
# for pair in base_MDP.MDP[1]:
#     sum = 0
#     print('Pair = ', pair)
#     # print('prob = ',base_MDP.MDP[1][pair][0] )
#     for k in base_MDP.MDP[1][pair][0]:
#         if k < 0:
#             print('WRONG')
#             print('pair = ', pair)
#         sum=sum + k
